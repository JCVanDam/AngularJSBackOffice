...
function docall() {
    ...
    cur_call = vertoHandle.newCall({
        ...
        caller_id_name: "vertocust", //$("#cidname").val(),
        caller_id_number: "vertocust", //$("#cid").val(),
...
function doshare(on) {
	...
	share_call = vertoHandle.newCall({
            destination_number: $("#ext").val() + "-screen",
            caller_id_name: "vertocust", //$("#cidname").val() + " (Screen)",
            caller_id_number: "vertocust", //$("#cid").val() + " (screen)",
	    outgoingBandwidth: outgoingBandwidth,
	    incomingBandwidth: incomingBandwidth,
...
/*
    ...
    pop("#login", "verto_demo_login", "vertocust");
    pop("#passwd", "verto_demo_passwd", "welcome");

    pop("#hostName", "verto_demo_hostname", "g-test.seampl.io");
    pop("#wsURL", "verto_demo_wsurl", "wss://g-test.seampl.io:443");
...
/*
    var tmp = $.cookie("verto_demo_dedenc_checked") || "false";
...
/*
    ...
    */
    ...
    var tmp = $.cookie("verto_demo_stereo_checked") || "true";
    ...
    */
    ...
    vertoHandle = new $.verto({
        login: "vertocust@g-test.seampl.io", //$("#login").val() + "@" + $("#hostName").val(),
        passwd: "welcome", //$("#passwd").val(),
        socketUrl: "wss://g-test.seampl.io:443", //$("#wsURL").val(),
        tag: video_screen,
