(function() {
	...
	var snapcall = {
			...
			switch (state) {
				...
				case 'callMute':
					$('.snapcall .commands-icons .mute').css({
						...
						'width': '30px',
						'height': '30px',
						'background-image': 'url(\'https://' + domain + '/libsc/snapcall/2.0.1/mic_off.png\')',
				...
				case 'callUnmute':
					$('.snapcall .commands-icons .mute').css({
						...
						'width': '30px',
						'height': '30px',
						'background-image': 'url(\'https://' + domain + '/libsc/snapcall/2.0.1/mic_on.png\')',
						'background-size': '30px 30px',
						'background-repeat': 'no-repeat',
						'background-position': 'center center',
						'border': '2px solid white',
		...
		loadCSS: function(callback) {
			$.get('https://' + domain + '/libsc/snapcall/2.0.1/snapcall.fn.css', function(res) {
		...
		loadHTML: function(callback) {
			$.get('https://' + domain + '/libsc/snapcall/2.0.1/snapcall.fn.html', function(res) {
				$('body').prepend(res);
				...
				$('.snapcall-btn').each(function() {
					...
					$.ajax({
						...
						success: function(res) {
							...
							btn.css({
								'width' : snapcall.style.width + 'px',
								'height' : snapcall.style.height + 'px',
								'background' : 'url(\'data:image/svg+xml;base64, ' + css + '\')',
								'background-size' : snapcall.style.width + 'px ' + snapcall.style.width + 'px',
								'background-position' : 'center center'
							});
						},
						error: function(res) {
